...
- `npm --prefix frontend run e2e:local` 只访问 `127.0.0.1:54321/mock`，覆盖邀请、登录、创建作业、Rubric、上传、批量评分、教师复核和 Excel 下载。它验证浏览器与前端编排，不代表真实 Supabase、Redis、Storage、模型或 Render 通过。
